...
TEXCONV = Path("C:/Users/waelj/texconv.exe")
GAME_DIR = Path("C:/Program Files (x86)/Steam/steamapps/common/Crimson Desert")

REPO_ROOT = Path(__file__).resolve().parent.parent
SOURCE_PNG_DIR = Path(
    r"C:\Users\waelj\AppData\Local\FortnitePorting\Assets\BRCosmetics"
    r"\Gadgets\Assets\VinderTech_GliderChute\Glider_OutlineLove\Texture"
)
STAGING_ROOT = Path(r"C:\Users\waelj\got-dragon-mod\textures\drogon_fortnite")
...
Run:
```bash
mkdir -p /c/Users/waelj/crimson-desert-got-dragon-mod/screenshots
mkdir -p /c/Users/waelj/crimson-desert-got-dragon-mod/docs/references
touch /c/Users/waelj/crimson-desert-got-dragon-mod/screenshots/.gitkeep
touch /c/Users/waelj/crimson-desert-got-dragon-mod/docs/references/.gitkeep
```
...
Edit `C:\Users\waelj\.claude\projects\C--Users-waelj\memory\MEMORY.md`: under the "Crimson Desert GoT Dragon Mod" section, replace the "FORTNITE DROGON … texture WIP" line with a one-line pointer to the spec + final shipping step.
