...
C:\Users\user\Downloads\cd_json_mm\CD JSON Mod Manager\mods\
...
```bash
cd /c/Users/user/crimson-desert-got-dragon-mod/.worktrees/feat-anim-retarget
...
def _list_via_crimsonforge(paz_path: Path) -> List[PazEntry]:
    ...
    import sys
    cf = Path(r"C:\Users\user\Downloads\CrimsonForge-446-5-1775146612")
...
**Files:**
- Create: `C:\Users\user\Downloads\cd_json_mm\CD JSON Mod Manager\mods\Drogon-AnimSpike-Phase1\mod.json`
- Create: `C:\Users\user\Downloads\cd_json_mm\CD JSON Mod Manager\mods\Drogon-AnimSpike-Phase1\files\<vanilla-relative-path>` (filled in this task)
- Modify: `docs/cd_anim_format_notes.md`
...
Replace `<JMM-MODS>` below with `C:\Users\user\Downloads\cd_json_mm\CD JSON Mod Manager\mods` (forward-slash form: `/c/Users/user/Downloads/cd_json_mm/CD JSON Mod Manager/mods`).

```bash
JMM_MODS="/c/Users/user/Downloads/cd_json_mm/CD JSON Mod Manager/mods"
