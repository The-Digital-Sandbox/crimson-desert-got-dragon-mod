...
- **Modify:** `C:\Users\user\Downloads\CrimsonForge-446-5-1775146612\build_pac_v10.py`
...
**Files:**
- Modify: `C:\Users\user\Downloads\CrimsonForge-446-5-1775146612\build_pac_v10.py:414`
...
Run:
```bash
cd /c/Users/user/Downloads/CrimsonForge-446-5-1775146612 && python -c "import ast; ast.parse(open('build_pac_v10.py').read()); print('Syntax OK')"
```
Expected: `Syntax OK`
...
```bash
cd /c/Users/user/Downloads/CrimsonForge-446-5-1775146612 && git add build_pac_v10.py && git commit -m "feat: add topology-aware submesh assignment function"
```
...
**Files:**
- Modify: `C:\Users\user\Downloads\CrimsonForge-446-5-1775146612\build_pac_v10.py` — `build_submesh_data()` function
...
```bash
cd /c/Users/user/Downloads/CrimsonForge-446-5-1775146612 && git add build_pac_v10.py && git commit -m "refactor: remove extra_verts from build_submesh_data, trust topology-aware assignment"
```
...
**Files:**
- Modify: `C:\Users\user\Downloads\CrimsonForge-446-5-1775146612\build_pac_v10.py` — `main()` function
...
Run:
```bash
cd /c/Users/user/Downloads/CrimsonForge-446-5-1775146612 && python build_pac_v10.py 2>&1
```
...
```bash
cd /c/Users/user/Downloads/CrimsonForge-446-5-1775146612 && git add build_pac_v10.py && git commit -m "feat: wire topology-aware assignment into main(), remove old face_owner computation"
```
...
Run:
```bash
cd /c/Users/user/Downloads/CrimsonForge-446-5-1775146612 && python build_pac_v10.py 2>&1 | tee /c/Users/user/crimson-desert-got-dragon-mod/output/v10_topology_build_log.txt
```
...
Run:
```bash
cd /c/Users/user/Downloads/CrimsonForge-446-5-1775146612 && python build_pac_v10.py --deploy
```
...
```bash
cd /c/Users/user/crimson-desert-got-dragon-mod && git add output/v10_topology_build_log.txt && git commit -m "docs: save V10 topology-aware build log"
```
